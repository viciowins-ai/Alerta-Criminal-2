                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <View className="flex-1 px-6 justify-center w-full max-w-md mx-auto">
                        ...
                        <View className="items-center mb-10">
                            ...
                            <Text className="text-white font-bold text-2xl tracking-wider mb-2">Alerta Criminal</Text>
                            <Text className="text-white font-bold text-3xl text-center">Acesso do Administrador</Text>
                        </View>
                        ...
                        <View className="flex-row bg-slate-800 p-1 rounded-xl mb-8 border border-slate-700">
                            ...
                            >
                                <Text className={`font-bold ${activeTab === 'login' ? 'text-white' : 'text-slate-400'}`}>Login</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                            ...
                            >
                                <Text className={`font-bold ${activeTab === 'cadastro' ? 'text-white' : 'text-slate-400'}`}>Cadastro</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        {step === 1 ? (
                            <>
                                {/* Phone Input */}
                                <View className="mb-6">
                                    <Text className="text-white font-medium mb-2 pl-1">Número de telefone</Text>
                                ...
                                <View className="gap-4">
                                    ...
                                    >
                                        ...
                                        <Text className="text-slate-200 font-bold text-base">Enviar Código via SMS</Text>
                                    </TouchableOpacity>
                                    ...
                                    >
                                        ...
                                        <Text className="text-slate-200 font-bold text-base">Via WhatsApp</Text>
                                    </TouchableOpacity>
                                </View>
                            </>
                        ) : (
                            <>
                                ...
                                <View className="mb-8">
                                    <Text className="text-white font-medium mb-2 pl-1">Código de verificação</Text>
                                ...
                                >
                                    ...
                                    <Text className="text-slate-900 font-bold text-lg">Verificar e Entrar</Text>
                                </TouchableOpacity>

                                <TouchableOpacity onPress={() => setStep(1)} className="mt-6">
                                    <Text className="text-slate-500 text-center text-sm">Alterar número de telefone</Text>
                                </TouchableOpacity>
                            </>
                        )}
                        ...
                        <TouchableOpacity className="mt-12">
                            <Text className="text-slate-600 text-center text-sm font-medium">Precisa de ajuda? Fale com o Suporte</Text>
                        </TouchableOpacity>
