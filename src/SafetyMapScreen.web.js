                ...
                <Popup className="custom-popup">
                  <View>
                    <Text style={{ fontWeight: "bold" }}>
                      {incident.type ? incident.type.toUpperCase() : "ALERTA"}
                    </Text>
          ...
          >
            <View className="bg-slate-900/60 border border-white/10 rounded-[32px] p-6 shadow-2xl backdrop-blur-3xl pointer-events-auto">
              <View className="flex-row justify-between items-start mb-6">
                <View>
                  <Text className="text-white font-extrabold text-[22px] tracking-tight">
                    Análise da Área
                  </Text>
                  <View className="flex-row items-center mt-1">
                    <View className="w-2 h-2 rounded-full bg-emerald-500 shadow-lg shadow-emerald-500/50 mr-2 animate-pulse" />
                    <Text className="text-emerald-400 text-[10px] font-bold uppercase tracking-[0.2em]">
                      Monitoramento Ativo
                    </Text>
                  </View>
                </View>
              ...
              <View className="flex-row gap-4">
                ...
                >
                  ...
                  <Text className="text-white font-bold text-[10px] uppercase mt-2 tracking-widest">
                    Localizar
                  </Text>
                </TouchableOpacity>
              </View>
