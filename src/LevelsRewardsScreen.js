...
const LevelsRewardsScreen = ({ navigation }) => {
  ...
  const getLevelInfo = (pts) => {
    if (pts < 100)
      return { current: "Guardião Bronze", next: "Guardião Prata", max: 100 };
    if (pts < 300)
      return { current: "Guardião Prata", next: "Guardião Ouro", max: 300 };
    if (pts < 600)
      return { current: "Guardião Ouro", next: "Guardião Platina", max: 600 };
    ...
    <SafeAreaView className="flex-1 bg-[#05070f] relative overflow-hidden">
      ...
      <View className="absolute top-12 left-6 right-6 h-16 z-20 pointer-events-none flex-row items-center justify-between bg-slate-900/50 backdrop-blur-3xl border border-white/10 rounded-full shadow-[0_0_20px_rgba(0,0,0,0.5)] px-4">
        ...
        <View className="items-center">
          ...
          <Text className="text-blue-400 text-[9px] font-black tracking-[0.3em] uppercase mt-1">
            Nível & Recompensas
          </Text>
        </View>
        <View className="w-10" />
      ...
      >
        ...
        <View className="items-center mt-6 mb-12">
          <View className="relative justify-center items-center mb-8 w-44 h-44 border-4 border-yellow-500/20 rounded-full bg-yellow-500/5 backdrop-blur-3xl">
            <View
              className="absolute inset-0 rounded-full border-r-2 border-yellow-400"
            ...
            <View className="absolute -bottom-4 bg-yellow-400 px-4 py-1.5 rounded-full items-center justify-center shadow-[0_0_15px_rgba(250,204,21,0.5)] border-2 border-[#05070f]">
              <Text className="text-[#05070f] font-black text-xs tracking-widest uppercase">
                Rank Secreto
              </Text>
            </View>
          </View>

          <Text className="text-blue-400 font-bold tracking-[0.2em] text-[10px] uppercase mb-1">
            Patente Atual
          </Text>
          <Text className="text-[26px] font-black tracking-widest text-white mb-6 uppercase text-center">
            {levelInfo.current}
          </Text>
        ...
        <Text className="text-white font-extrabold text-[15px] tracking-wide mb-5">
        ...
        >
          ...
          <View className="bg-slate-800/40 p-5 rounded-3xl border border-emerald-500/20 w-44 items-center shadow-lg backdrop-blur-md">
            ...
            <Text className="text-white font-black tracking-wide text-center mb-2 text-[14px]">
              Distintivo Verificado
            </Text>
            <Text className="text-slate-500 text-[11px] text-center leading-4 font-bold">
              Autenticidade visível na rede.
            </Text>
          </View>
          ...
          <View className="bg-slate-800/40 p-5 rounded-3xl border border-blue-500/20 w-44 items-center shadow-lg backdrop-blur-md">
            ...
            <Text className="text-slate-500 text-[11px] text-center leading-4 font-bold">
              Filtros avançados do mapa liberados.
            </Text>
          </View>
        </ScrollView>
        ...
        <View className="flex-row gap-4 mb-10 w-full">
          <View className="flex-1 bg-slate-900/60 p-5 rounded-3xl border border-white/5 border-dashed items-center justify-center h-36">
            ...
            <Text className="text-slate-300 font-extrabold text-center text-[12px] uppercase tracking-widest mb-1 opacity-50">
              Acesso Tático
            </Text>
            <Text className="text-slate-600 font-bold text-[9px] text-center uppercase">
              Requer Nível Ouro
            </Text>
          </View>
        ...
        <View className="gap-4 w-full">
          <View className="bg-slate-800/40 p-5 rounded-3xl border border-white/5 flex-row items-center justify-between backdrop-blur-md">
            <View className="flex-row items-center gap-4">
              ...
              <View>
                <Text className="text-white font-extrabold text-[14px] tracking-widest uppercase">
                  Reportar Alerta
                </Text>
                <Text className="text-slate-400 font-bold text-[10px] uppercase mt-1">
                  Acionar radar no perigo
                </Text>
              </View>
            </View>
            <View className="bg-blue-600/20 px-3 py-1.5 rounded-full border border-blue-500/30">
              <Text className="text-blue-400 font-black text-[12px]">
                +50 XP
              </Text>
            </View>
          </View>
          ...
          <View className="bg-slate-800/40 p-5 rounded-3xl border border-white/5 flex-row items-center justify-between backdrop-blur-md">
            ...
            <View className="bg-emerald-600/20 px-3 py-1.5 rounded-full border border-emerald-500/30">
              <Text className="text-emerald-400 font-black text-[12px]">
                +10 XP
              </Text>
            </View>
          </View>

          <TouchableOpacity className="bg-purple-900/40 p-5 rounded-3xl border border-purple-500/30 flex-row items-center justify-between backdrop-blur-md mb-8 active:bg-purple-900/60 shadow-[0_0_20px_rgba(168,85,247,0.15)]">
            <View className="flex-row items-center gap-4">
              ...
              <View>
                ...
                <Text className="text-purple-300 font-bold text-[10px] uppercase mt-1">
                  Convidar no Programa
                </Text>
              </View>
            </View>
            <View className="bg-purple-600/30 px-3 py-1.5 rounded-full border border-purple-400/50">
              <Text className="text-purple-300 font-black text-[12px]">
                +500 XP
              </Text>
            </View>
          </TouchableOpacity>
