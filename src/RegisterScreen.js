      ...
      >
        ...
        >
          <TouchableOpacity
            ...
            className="w-10 h-10 bg-slate-800 rounded-full items-center justify-center border border-slate-700 mb-6"
          >
          ...
          <Text className="text-slate-400 text-base mb-12">
            Junte-se à comunidade e proteja o seu bairro.
          </Text>
          ...
          >
            ...
            />
            <Text
              className="text-gray-600 font-semibold text-base flex-1 text-center"
              style={{
