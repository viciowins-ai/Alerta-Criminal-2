...
const TIPS = [
  {
    ...
    category: "Casa",
    content:
      "Evite demorar para abrir o portão. Verifique o entorno antes de entrar e se possível, mantenha a área iluminada.",
    premium: false,
    image:
  ...
  },
  {
    ...
    category: "Digital",
    content:
      "Ative a confirmação em duas etapas e nunca compartilhe códigos SMS com ninguém.",
    premium: false,
    image:
  ...
  },
  {
    ...
    category: "Rua",
    content:
      "Aprenda pontos vitais e como se desvencilhar de agarramentos. Conteúdo exclusivo para assinantes.",
    premium: true,
    image:
  ...
  },
  {
    ...
    category: "Carro",
    content:
      "Mantenha os vidros fechados e não deixe objetos de valor à vista. Fique atento aos retrovisores.",
    premium: true,
    image:
        ...
        >
              ...
              <View className="z-10 relative">
                <View className="flex-row justify-between items-start mb-4">
                  <View className="bg-blue-900/40 px-3 py-1.5 rounded-lg border border-blue-400/30">
                    <Text className="text-blue-100 text-xs font-bold uppercase tracking-wide">
                      Essencial
                    </Text>
                  </View>
                ...
                <Text className="text-white font-black text-2xl w-3/4 mb-3 leading-7">
                  Não reaja a assaltos
                </Text>
                <Text className="text-blue-100 text-sm leading-6 mb-5 font-medium opacity-90">
                  Sua vida vale mais que qualquer bem material. Mantenha a calma
                  e faça movimentos lentos.
                </Text>
          ...
          <View className="px-6 mb-6">
            ...
            >
              ...
              >
                <Text
                  className={`font-bold text-sm ${!selectedCategory ? "text-white" : "text-slate-400"}`}
                >
                  Todas
                </Text>
              </TouchableOpacity>
              {CATEGORIES.map((cat) => (
                ...
                >
                  ...
                  />
                  <Text
                    className={`font-bold text-sm ${selectedCategory === cat.name ? "text-white" : "text-slate-400"}`}
                  >
                    {cat.name}
                  </Text>
                </TouchableOpacity>
          ...
          <View className="px-6 gap-5">
            ...
            {filteredTips.map((tip) => (
              <TouchableOpacity
                key={tip.id}
                className="bg-slate-800/60 rounded-3xl overflow-hidden border border-slate-700/50 shadow-sm active:scale-[0.98] transition-all"
              >
                <View className="h-40 w-full relative">
                  ...
                  {tip.premium && (
                    <View className="absolute top-3 right-3 bg-yellow-400/90 px-2.5 py-1 rounded-lg flex-row items-center gap-1.5 shadow-lg backdrop-blur-sm">
                      ...
                      <Text className="text-yellow-950 text-[10px] font-black uppercase tracking-wide">
                        Premium
                      </Text>
                    </View>
                  )}
                  ...
                  <View className="absolute bottom-3 left-4 right-4">
                    <Text className="text-blue-400 text-xs font-bold uppercase tracking-wider mb-1 drop-shadow-md">
                      {tip.category}
                    </Text>
                    <Text className="text-white font-bold text-xl leading-6 drop-shadow-md">
                      {tip.title}
                    </Text>
                  </View>
                </View>
                ...
                <View className="p-5 relative">
                  <Text
                    className="text-slate-300 text-sm leading-6 mb-4 font-light"
                    numberOfLines={2}
                  >
                    {tip.content}
                  </Text>
                  ...
                  <View className="flex-row items-center justify-between pt-2 border-t border-slate-700/30">
                    ...
                    {tip.premium ? (
                      <View className="flex-row items-center gap-2">
                        ...
                        <Text className="text-yellow-400 text-xs font-bold uppercase tracking-wide">
                          Desbloquear
                        </Text>
                      </View>
                    ) : (
          ...
          <View className="mx-6 mt-8 mb-4">
            ...
            >
              <View className="relative z-10 flex-1 pr-2">
                <Text className="text-white font-black text-xl mb-1.5 drop-shadow-sm">
                  Seja Guardiã Ouro
                </Text>
                <Text className="text-yellow-50 text-xs mb-4 leading-5 opacity-90">
                  Acesso ilimitado a dicas avançadas, aulas de autodefesa e
