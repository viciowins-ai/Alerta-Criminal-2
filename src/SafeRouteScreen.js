    ...
    <SafeAreaView className="flex-1 bg-background-dark">
      ...
      <View className="flex-1 px-5 pt-4">
        ...
        <View className="bg-yellow-900/20 border border-yellow-700/30 rounded-xl p-4 flex-row items-center gap-4 mb-6">
          ...
          <Text className="text-yellow-500 font-medium flex-1 text-sm">
            Você está usando o Planejador de Rota Premium.
          </Text>
        </View>
        ...
        <View className="gap-4 mb-6">
          <View>
            <Text className="text-white font-bold mb-2 ml-1">
              Ponto de partida
            </Text>
        ...
        <View className="bg-slate-800 rounded-2xl p-5 border border-slate-700 mb-6">
          ...
          <Text className="text-slate-400 text-sm leading-5">
            A rota sugerida pela IA evita 3 áreas de alto risco reportadas
            recentemente.
          </Text>
        </View>
      </View>
